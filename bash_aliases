...
# dockerized programs
alias sandfox="docker run --rm -d -v /var/run/dbus/:/var/run/dbus/ -v /run/user/1001/pulse/:/run/user/1001/pulse/ -v /home/marco/.mozilla:/home/firefox/.mozilla -v /home/marco/Downloads:/home/firefox/Downloads -v /home/marco/.pulse-cookie:/home/firefox/.pulse-cookie -v /tmp/.X11-unix:/tmp/.X11-unix --name sandfox --hostname sandfox.midgar.net -v /dev/shm:/dev/shm -e DISPLAY=:0 sandfox:latest"
