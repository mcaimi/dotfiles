...
case $COMMAND_SELECTION in
  "1")  $HOME/.config/qtile/scripts/multimon.sh "dock" && i3-msg restart
        ;;
  "2")  $HOME/.config/qtile/scripts/multimon.sh "undock" && i3-msg restart
        ;;
  "3")  $HOME/.config/qtile/scripts/multimon.sh "extleft" && i3-msg restart
        ;;
  "4")  $HOME/.config/qtile/scripts/multimon.sh "extright" && i3-msg restart
        ;;
  "5")  $HOME/.config/qtile/scripts/multimon.sh "mirror" && i3-msg restart
        ;;
  "6")  $HOME/.config/qtile/scripts/multimon.sh "panic" && i3-msg restart
        ;;
esac
