...
function _rofi {
    rofi -location 0 -show combi -padding 2 -xoffset 0 -yoffset 0 -bw 0 -lines 20 -width 35 -font "iosevka term medium 11" -tokenize -no-levenshtein-search -dmenu "$@" -p "token >"
}
